...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--output_dir', default='./output/five_datasets_lear', type=str, help='Output folder')

    # LEAR's main_domain currently uses get_all_datasets() for domain sequence.
    subparsers.add_argument('--dataset', default='seq-cifar10', type=str, help='Placeholder dataset arg for LEAR parser')
