...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--output_dir', default='./output/ima_lear', type=str, help='Output folder')

    # NOTE: LEAR dataset registry in this repo does not currently include seq-imagenet-a.
    # Override this value once seq-imagenet-a is added to lear/datasets.
