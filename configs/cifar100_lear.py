...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--output_dir', default='./output/cifar100_lear', type=str, help='Output folder')

    subparsers.add_argument('--dataset', default='seq-cifar100', type=str, help='LEAR dataset name')
